...
Обратите, пожалуйста, внимание, что фото должно быть без бликов и посторонних предметов.''')
    passport = open(path + '/files/tgtemplates/passport1.jpg', 'rb')
...
def after_passport1(message, type):
    global photo_type
    if type == 'passport2':
        template = open(path + '/files/tgtemplates/passport2.jpg', 'rb')
...
Прикрепите, пожалуйста, фото документа Паспорт(4-5 страницы) согласно образцу''')
        ...
        photo_type = type
    if type == 'passport3':
        template = open(path + '/files/tgtemplates/passport3.jpg', 'rb')
        bot.send_photo(message.chat.id, template,
...
Прикрепите, пожалуйста, фото документа Паспорт(6-7 страницы) согласно образцу''')
        ...
        photo_type = type
    if type == 'passport7':
        template = open(path + '/files/tgtemplates/passport7.jpg', 'rb')
        bot.send_photo(message.chat.id, template,
...
Прикрепите, пожалуйста, фото документа Паспорт(18-19 страницы) согласно образцу''')
        ...
        photo_type = type
    if type == 'bank':
        template = open(path + '/files/tgtemplates/bank.jpg', 'rb')
        bot.send_photo(message.chat.id, template,
...
Прикрепите, пожалуйста, фото документа Текущие личные банковские реквизиты  согласно образцу''')
        ...
        photo_type = type
    if type == 'snils':
        template = open(path + '/files/tgtemplates/snils.jpg', 'rb')
        bot.send_photo(message.chat.id, template,
...
def get_user_pics(message):
    ...
    dirName = '/files/bot/' + str(message.chat.id)
